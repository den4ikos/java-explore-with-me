...
alter table subscribers drop constraint if exists fk_subscriber_id_subscribers;
alter table subscribers add constraint fk_subscriber_id_subscribers foreign key (subscriber_id) references users (id) on delete cascade;

alter table subscribers drop constraint if exists fk_event_owner_subscribers;
alter table subscribers add constraint fk_event_owner_subscribers foreign key (event_owner) references users (id) on delete cascade;

alter table subscribers drop constraint if exists fk_event_id_subscribers;
alter table subscribers add constraint fk_event_id_subscribers foreign key (event_id) references events (id) on delete cascade;

comment on column subscribers.subscriber_id is 'This is a subscriber';
comment on column subscribers.event_owner is 'This is an event owner';
comment on column subscribers.event_id is 'This is an event and subscriber can subscribe to it';
