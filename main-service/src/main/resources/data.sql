...
alter table subscribers drop constraint if exists fk_signatory_id_subscribers;
alter table subscribers add constraint fk_signatory_id_subscribers foreign key (signatory_id) references users (id) on delete cascade;
